...
namespace Scharfrichter.Codec.Effect
{
    class SoftLimiter : Effect
    {
        ...
        public EffectParameter Boost { get; } = new EffectParameter(0f, 0f, 30f, "Boost");
        public EffectParameter Brickwall { get; } = new EffectParameter(-0.1f, -10.0f, 1f, "Output Brickwall(dB)");
